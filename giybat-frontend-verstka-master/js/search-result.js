...
window.addEventListener("DOMContentLoaded", function () {
    var url_string = window.location.href; // www.test.com?query=dasdasd
        ...
        .then(data => {
            ...
            // if (data.content && data.content.length > 0){
                ...
                if (data.totalElements == 0){
                    document.getElementById("searchQueryTagId").textContent = "Qidirilgan \"" +query +"\" bo'yicha ma'lumot topilmadi!";
                    document.getElementById("searchQueryResultTagId").textContent = "";
                }else {
                    document.getElementById("searchQueryTagId").textContent = "Qidiruv: \""+ query + "\"";
                    document.getElementById("searchQueryResultTagId").textContent = data.totalElements + " ta topildi";
                }
            // }
        })
        .catch(error => {
